...
{
    sealed public class SaverEquation:AbstractSave
    {
        private string extension = ".saveEquation";
        private EquationData data;
        public SaverEquation(string nameFile)
        {
            this.nameFile = nameFile;
            data = new EquationData();
            data = (EquationData)LoadFromBinaryFile();
        }
        ...
        public List<string> GetEquationData()
        {
